...
class ScaBrowsingViewController: UIViewController
{
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?)
    {
        ...
        {
        case ScaBrowsingViewController.scaHorizontalSegueId:
    ...
    {
        performSegue(withIdentifier: ScaBrowsingViewController.walkthroughSegueId,
                     sender: self)
    }
}
